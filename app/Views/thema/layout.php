...
<head>
    ...
    <meta name="description" content="Portal CIGAM">
    <meta name="author" content="CIGAM - Your Select">

    <title>Portal CIGAM | <?= 'YOUR SELECT' ?></title>

    <link rel="shortcut icon" href="<?= base_url('dist/img/favicon.ico'); ?>" />
    ...
    <!-- Font Awesome -->
    <script defer src="<?= base_url('dist/js/all.js'); ?>"></script>
</head>
...
<body class="hold-transition dark-mode sidebar-mini sidebar-collapse">
    ...
    <div class="wrapper">
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="<?= base_url('dist/img/favicon.ico'); ?>" alt="CIGAM Logo" height="60" width="60">
        </div>
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand navbar-dark mb-1">
            <!-- Left navbar links -->
            <ul class="navbar-nav barmenu">
                <li class="nav-item">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" id="dropUser" role="button" href="#" aria-expanded="false">
                        <i class="fas fa-user-circle fa-lg mr-auto" alt="User Image"></i>
                        <?= 'Nome Usuário' ?>
                    </a>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" aria-labelledby="dropUser">
                        <span class="dropdown-header">Menu User</span>
                        <div class="dropdown-divider"></div>
                        <a href="#" class="dropdown-item text-center"><i class="fas fa-columns mr-2"></i>Meu Kanban</a>
                        <div class="dropdown-divider"></div>
                        <a href="#" class="dropdown-item text-center"><i class="fas fa-key mr-2"></i> Alterar Senha</a>
                        <div class="dropdown-divider"></div>
                        <a href="#" class="dropdown-item dropdown-footer">Sair <i class="fas fa-sign-out-alt fa-sm"></i></a>
                    </div>
                </li>
            </ul>
        </nav>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Bryan O'Conner</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-header">Preferências</li>
                        <li class="nav-item">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2021 <a href="https://www.cigam.com.br/">CIGAM</a>.</strong> All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
